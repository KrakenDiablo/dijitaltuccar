...
<body class="bg-theme bg-theme1">
	...
	<div class="wrapper">
		...
		$gms = file_get_html('https://www.gamesatis.com/knight-online-goldbar');
		$kbskl = file_get_html('https://www.kabasakalonline.com/knight-online/knight-online-goldbar');
		?>
		<!-- GameSatış parse -->
		<!-- KoPazar parse -->
				...
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<table id="example" class="table table-bordered text-center" style="width:100%; font-size:11px;">
								<thead>
									<tr>
										<th style="width:110px;">SİTELER</th>
										<th colspan="2">FELIS</th>
										<th colspan="2">PANDORA</th>
										<th colspan="2">AGARTHA</th>
										<th colspan="2">SIRIUS</th>
										<th colspan="2">ALTAR</th>
										<th colspan="2">VEGA</th>
										<th colspan="2">DESTAN</th>
									</tr>
								</thead>
								<tbody>
									<tr>
									...
									<tr>
										<td><img src="https://images.gamesatis.com/assets/logo-light.svg" width="100px"></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 0)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 1)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 2)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 3)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 4)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 5)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 8)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 9)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 10)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 11)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 12)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 13)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 14)->outertext; ?></td>
										<td><?php echo $test = $gms->find("div.goldbar-row-price div", 15)->outertext; ?></td>
									</tr>
									<tr>
										<td><img src="https://www.kabasakalonline.com/theme/default/assets/img/logo.png?v=0.1" width="100px"></td>
										<td></td>
										<td><?php echo $test = $kbskl->find("div.min-stats div.=stat-box buttons'> <span data-type='bizesat'>", 1)->outertext; ?></td>
										<td>test</td>
										<td><?php echo $test = $kbskl->find("div.right-wr <span class='price'>", 1)->outertext; ?></td>
										<td><?php echo $test = $kbskl->find("div.right-wr <p class='price'> ", 0)->outertext; ?></td>
										<td><?php echo $test = $kbskl->find("div.product object-item-117821 product-item-117821", 1)->outertext; ?></td>
										<td><?php echo $test = $kbksl->find("#t-products  div  div:nth-of-type(3)  a  div:nth-of-type(2)  p:nth-of-type(2)  span  span:nth-of-type(1)", 0)->outertext; ?></td>
										<td><?php echo $test = $html->find("div.goldbar-row-price div", 1)->outertext; ?></td>
										<td><?php echo $test = $html->find("div.goldbar-row-price div", 0)->outertext; ?></td>
										<td><?php echo $test = $html->find("div.goldbar-row-price div", 1)->outertext; ?></td>
									</tr>
								</tfoot>
							</table>
